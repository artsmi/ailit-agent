...
| [`desktop-memory-3d-observability.md`](desktop-memory-3d-observability.md) | §3.2 / UC-03–06: compact-события `pag_graph_rev_reconciled`, `pag_snapshot_refreshed`, `memory_recall_ui_phase`; D-PROD-1 (renderer-only rev reconcile); D-OBS-HI-1 (whitelist W14 v1). |
