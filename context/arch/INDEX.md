...
| [`desktop-pag-graph-snapshot.md`](desktop-pag-graph-snapshot.md) | Снимок PAG-графа в renderer, `pagDatabasePresent`, full load, поллер ожидания sqlite, 3D UI; **1.3** — `graphDataKey` (без `n` по числу нод), merge с сохранением `x..fz`, G16.4. |
