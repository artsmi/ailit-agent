...
| G20.3 | D1, D7: `memory query` через broker; удаление/обход in-process пути по умолчанию; сохранение exit codes и stderr UX. **Anchors:** `memory_query_orchestrator.py`, `memory_cli.py`, `cli.py` argparse. |
