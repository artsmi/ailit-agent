...
- указываешь, какие `context/*` sections, индексы и memory entries должен проверить или обновить `13_tech_writer`: `arch`, `install`, `start`, `modules`, `files`, `models`, `proto`, `tests`, `memories`;
...
9. Составь writer guidance: какие `context/arch`, `context/install`, `context/start`, `context/modules`, `context/files`, `context/models`, `context/proto`, `context/tests`, `context/memories` и какие `INDEX.md` должен проверить `13`.
...
5. Сформируй guidance для `13`: создать или дополнить `context/arch`, `context/install`, `context/start`, `context/modules`, `context/files`, `context/models`, `context/proto`, `context/tests`, `context/memories` и их индексы.
