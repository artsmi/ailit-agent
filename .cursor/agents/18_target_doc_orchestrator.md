...
5. Не анализируй код.
6. Запусти `20_target_doc_synthesizer` через Cursor Subagent tool call с `current_state_reports=[]`, `donor_reports=[]`, `previous_target_doc` если передан, и raw request.
