...
- Обновляешь только подтверждённые и затронутые knowledge sections в `context/arch/`, `context/install/`, `context/start/`, `context/modules/`, `context/files/`, `context/models/`, `context/proto/`, `context/tests/`, `context/memories/`.
