...
_LEGACY = _REPO / "tools" / "agent_core" / "legacy"
_PIPELINE = _RUNTIME / "agent_memory_query_pipeline.py"
...
def test_legacy_c_extraction_modules_are_deleted_or_quarantined() -> None:
    """
    A14R.15: legacy модули вне `runtime`, под `agent_core.legacy` (D14R.4).
    """
...
def test_w14_runtime_does_not_import_legacy_c_extraction() -> None:
    """
    W14: в `agent_core.runtime` нет import legacy имён (файлы C extraction).
