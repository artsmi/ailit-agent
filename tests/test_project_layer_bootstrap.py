...
from project_layer.bootstrap import compute_chat_tuning, compute_workflow_augmentation
...
def test_registry_agent_fallback() -> None:
    ...
    loaded = LoadedProject(root=Path.cwd(), config_path=Path("project.yaml"), config=cfg)
