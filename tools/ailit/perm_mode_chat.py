"""perm-5: классификатор режима для одного хода ailit chat."""
...
from agent_core.session.mode_decision_kb import (
    MODE_DECISION_KIND,
...
class ChatPermModeCoordinator:
    ...
    def resolve_turn(
        ...
        *,
        ...
        kb = self._open_kb()
        if kb is not None:
            pdef = ChatPermModeCoordinator.project_default_mode_from_kb(
                kb,
