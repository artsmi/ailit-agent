...
| **Desktop memory graph 3dmvc (plan 18)** | **G1 в коде (2026-05-12):** [`plan/18-desktop-memory-graph-3dmvc.md`](plan/18-desktop-memory-graph-3dmvc.md) — проекция **D-ORPHAN-B** / **OR-003** в `MemoryGraphForceGraphProjector`; канон — [`context/algorithms/desktop/INDEX.md`](context/algorithms/desktop/INDEX.md). Ручной smoke §6 плана — **verification_gap** до отдельного e2e/операторского прогона. |
