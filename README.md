...
| Bash / shell в runtime | [`plan/ailit-bash-strategy.md`](plan/ailit-bash-strategy.md): этапы **A–G** и **H** (сессионный shell после B–C); задел в `agent_core.shell_output_preview`. |
