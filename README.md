...
| **AgentMemory LLM + journal (workflow 11)** | [**`plan/11-agent-memory-llm-journal.md`**](plan/11-agent-memory-llm-journal.md) — **активно:** G11.8 переводит Memory 3D в product mode: real PAG/D graph only, multi-project namespaces, live growth/highlights. |
