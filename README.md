...
| Токен-экономия и внешняя память (ветка) | **Порядок:** [`plan/workflow-token-economy-recipe.md`](plan/workflow-token-economy-recipe.md) (TE — постановка закрыта) → [`plan/workflow-hybrid-memory-mcp.md`](plan/workflow-hybrid-memory-mcp.md) (H0–H4) → [**`plan/workflow-memory-3.md` — workflow M3 завершён (2026-04)**](plan/workflow-memory-3.md) (реализация, unified summary, KB/promotion, сравнение с донорами: [`docs/ailit-ai-memory-implementation.md`](docs/ailit-ai-memory-implementation.md)). |
