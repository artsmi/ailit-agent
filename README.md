...
| **AgentMemory LLM + journal (workflow 11)** | [**`plan/11-agent-memory-llm-journal.md`**](plan/11-agent-memory-llm-journal.md) — **активно:** G11.5 добавляет namespace-aware `context.memory_injected.v2` с `project_refs[]` и совместимый Desktop highlight parser. |
