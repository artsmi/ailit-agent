...
| **Workflow 14 (AgentMemory runtime W14, command protocol)** | **Открыт:** [`plan/14-agent-memory-runtime.md`](plan/14-agent-memory-runtime.md) — G14R.5–G14R.6 закрыты: `agent_memory_summary_service` + quarantine legacy C extraction в `agent_core.legacy`; далее G14R.7+ по плану. |
