...
| **Context Ledger + Memory 3D highlights (workflow 10)** | [**`plan/10-context-ledger-memory-highlights.md`**](plan/10-context-ledger-memory-highlights.md) — **активно:** G10.3 добавляет model limits, effective context window, reserve output tokens и warning states; дальше — Desktop Context Fill. |
