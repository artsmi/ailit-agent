...
| **Context Ledger + Memory 3D highlights (workflow 10)** | [**`plan/10-context-ledger-memory-highlights.md`**](plan/10-context-ledger-memory-highlights.md) — **активно:** G10.4 добавляет Desktop Context Fill panel по событиям `context.*`; дальше — compact в D-level memory. |
