...
| Bash / shell в runtime | [`plan/ailit-bash-strategy.md`](plan/ailit-bash-strategy.md): этапы **A–G** (инструменты, безопасность, UX Chat/TUI); задел в `agent_core.shell_output_preview`. |
