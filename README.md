...
| **Context Ledger + Memory 3D highlights (workflow 10)** | [**`plan/10-context-ledger-memory-highlights.md`**](plan/10-context-ledger-memory-highlights.md) — **активно:** G10.5 создаёт D-level compact/session artifacts в PAG и эмитит `context.compacted`; дальше — automatic context restore. |
