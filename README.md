...
| **Context Ledger + Memory 3D highlights (workflow 10)** | [**`plan/10-context-ledger-memory-highlights.md`**](plan/10-context-ledger-memory-highlights.md) — **активно:** G10.6 восстанавливает контекст из D-level summaries при открытии Desktop-чата; дальше — Memory 3D highlights по Context Ledger. |
